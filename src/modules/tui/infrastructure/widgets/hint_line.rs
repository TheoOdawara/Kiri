...
pub fn render(model: &Model, frame: &mut Frame, area: Rect) {
    let line = if model.pending_approval.is_some() {
        ...
        let variants = [
            "  Enter envia · ⇧Tab modo · Alt+Enter nova linha · ↑↓ histórico · ⇧↑↓/PgUp/PgDn rola · ^Home/^End topo/fundo · ^C/^D sai · /help",
            "  Enter envia · ⇧Tab modo · ↑↓ histórico · PgUp/PgDn rola · ^C sai · /help",
