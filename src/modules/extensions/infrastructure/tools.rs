...
mod tests {
    ...
    fn read_only_extension_tools_are_exactly_the_known_safe_set() {
        // SEC-01 / ADR 0029: locks the read-only surface a headless subagent can hold. A new read-only
        // extension tool must be reviewed against SEC-01 before it lands here.
